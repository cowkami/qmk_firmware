...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 /* Qwerty
  ...
  [_LOWER] = LAYOUT( \
      ...
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   _______, _______, KC_LPRN, KC_RPRN, KC_PIPE, \
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, _______, _______, _______, _______, _______,                   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_BSPC, KC_BSLS, \
      _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, KC_DEL,  _______, \
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ \
      ),
...
static void render_layout(struct CharacterMatrix *matrix) {
  switch (default_layer_state-1) {
      ...
      case _QWERTY:
          ...
          break;
      default:
          matrix_write_P(matrix, PSTR("other"));
  }
}
